...
```hcl
module "ssh-key" {
  source     = "git::https://github.com/chahalvikas2022/terraform-digitalocean-ssh-key.git"
  name       = "test"
...
# Examples
For detailed examples on how to use this module, please refer to the '[example](https://github.com/chahalvikas2022/terraform-digitalocean-ssh-key/tree/master/_example)' directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/chahalvikas2022/terraform-digitalocean-ssh-key/blob/master/LICENSE) file for details.
